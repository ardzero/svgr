[![svgr](https://svgr.ardzero.com/ogImage.webp)](https://svgr.ardzero.com/)

# Svgr

An open source SVG directory with fuzzy search build with Astro and react. [Live deployment](https://svgr.ardzero.com/)
